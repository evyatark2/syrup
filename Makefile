...
CHANNEL_SRCS=$(COMMON_SRCS) channel/server.c channel/main.c channel/handlers.c channel/client.c channel/map.c channel/drops.c channel/config.c channel/scripting/client.c channel/scripting/job.c channel/scripting/script-manager.c
